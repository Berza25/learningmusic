                    ...
                    <td align="center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{route('materi.edit',$item->id)}}"><i class="fa fa-edit"></i> Edit</a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="POST" id="insert_form" action="{{ route('materi.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <label>Title</label>
