...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body">
                <form method="POST" id="insert_form" action="{{ route('profileuser.update', $user->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <label>Name</label>
                    ...
                    <span class="small text-danger"><small>*Jika tidak mengganti password, harap dikosongkan</small></span>
                    <div class="row">
                        <div class="col-lg-4">
